    ...
    <div class="container mx-auto px-7 2xl:px-40 pt-32">
        <div>
            <div class="text-center">
                <h1 class="font-bold text-2xl capitalize mb-5">Our Fresh BLogs</h1>
        ...
        <div class="grid grid-cols-3 mt-20">
            <div class="col-span-2 pe-7">

                <img src="/images/blog.jpg" class="w-full rounded" style="height: 430px;" />
        ...
        <div class="grid grid-cols-3 gap-x-4 gap-y-10 mt-16">
            <div>
                <img src="/images/blog1.jpg" class="w-full h-60 rounded" />
