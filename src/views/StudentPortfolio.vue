<template>
    <div class="container mx-auto px-8 2xl:px-40 pt-20">
        <div class="flex flex-col items-center py-20">
            ...
            <div class="text-center w-1/2">
                ...
                <p class="text-sm mb-6">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Itaque
                    ...
                    temporibus ipsa id
                    laboriosam
                    ea, tempora quisquam corrupti quis modi, excepturi rerum architecto, ut distinctio dignissimos
                    consequuntur commodi sint! Impedit?</p>
                <button class="btn border-orange-500 bg-orange-500 text-white mx-1.5 hover:text-black">Get In
                    Touch</button>
