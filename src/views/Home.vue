          ...
          >
            <div class="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
              <div class="w-full md:w-96 xl:w-3/4 m-auto">
                <h1 class="text-5xl font-semibold leading-normal tracking-wider">
                  Start <span class="text-info font-bold">Learning</span> & Define Your
                  <span class="text-orange-400 font-bold">Future</span>
                </h1>
                <p class="mt-4">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Incidunt
                  voluptates modi magni libero aut! Veritatis quos possimus ad officia
                  repudiandae, saepe sint eos. Ipsam, porro. Hic beatae doloribus rerum.
                </p>
                <div class="mt-5">
                  <div class="flex mb-2">
                ...
                <div class="mt-8 flex items-center">
                  ...
                  <div
                    class="flex items-center ms-5 cursor-pointer"
                    onclick="guide.showModal()"
                  >
                  ...
                  <dialog ref="modal" id="guide" class="modal" @closed="closeModal">
                    <div class="modal-box p-0">
                      <iframe
                        ref="videoFrame"
                        class="w-full h-96"
                        src="https://www.youtube.com/embed/tZJ1G1hO8H8?si=mco2tvJoJ73EFysu"
        ...
        <div class="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
          <div class="lg:w-full lg:max-w-2xl lg:flex-auto">
            <p class="text-xl leading-8 text-gray-600">
              ...
              ac. Diam nulla orci at in viverra scelerisque eget. Eleifend egestas
              fringilla sapien.
            </p>
          ...
          <swiper-slide data-hash="slide1">
            <div class="px-0 md:px-16">
              ...
              <p>
                ...
                pariatur, similique in natus dolor ipsum dolores quas placeat iusto
                repellat velit assumenda iste cumque modi omnis! Quod, dolor dolore. Lorem
                ipsum dolor sit, amet consectetur adipisicing elit. Corporis aliquid
                pariatur, similique in natus dolor ipsum dolores quas placeat iusto
                repellat velit assumenda iste cumque modi omnis! Quod, dolor dolore.
              </p>
      ...
      <div class="mt-16 md:mt-0 grid sm:grid-cols-1 md:grid-cols-2 flex items-center">
        <div class="mt-10 md:mt-0">
          <p class="leading-relaxed">
            ...
            molestiae neque reprehenderit quisquam quasi laboriosam nobis. Reiciendis
            laboriosam excepturi necessitatibus dicta! Dolore, quod a! Tempore, quia.
            Molestias, maxime perferendis. Lorem ipsum dolor sit amet consectetur
            adipisicing elit. Architecto similique alias fugiat maiores provident placeat
            deserunt at reiciendis ab. Dolor, nisi. Facilis enim voluptate, ipsum
            reiciendis vel cumque amet! Optio?
          </p>
        ...
        <div class="">
          <form>
              ...
              <div class="pb-8">
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                  ...
                  <div class="col-span-full">
                    <label for="about" class="block leading-6 text-gray-900"
                      >Message</label
                    >
                    <div class="mt-2">
                      <textarea
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
              <button
                type="submit"
                class="rounded-md bg-cyan-500 px-3 py-2 font-semibold text-white shadow-sm hover:bg-cyan-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-500"
              >
                Send Message
              </button>
            </div>
